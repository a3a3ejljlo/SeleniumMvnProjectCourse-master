...
public class DepositTest extends BaseTest {
    ...
    public void testDeposit() {
        ...
        scrollAndClick(driver.findElement(By.xpath(
                "//p[contains(text(),'На каждый день')]/ancestor::div[@class='b-card__content']//*[text()='Открыть счет']")));
        click(driver.findElement(By.xpath("//a[text()='Оставить заявку'][@class='button']")));

        Assert.assertEquals("На каждый день",
                            driver.findElement(By.xpath("//*[text()='Накопительный счет']/parent::div/div")).getText());
        ...
        fillDate(driver.findElement(By.xpath("//*[text()='Дата рождения']/parent::div/input")),
                 testData.get("Дата рождения"));
        ...
        Assert.assertEquals(testCheckData.get("Дата рождения"),
                            driver.findElement(By.xpath("//*[text()='Дата рождения']/parent::div/input"))
                                  .getAttribute("value"));
        Assert.assertEquals(testCheckData.get("Телефон"),
                            driver.findElement(By.xpath("//*[text()='Телефон']/parent::div/input"))
                                  .getAttribute("value"));
        ...
        Assert.assertTrue("Не найден элмент - Осталось заполнить: Телефон", isElementPresent(By.xpath(
                "//div[@class='page-item__invalid'][.//div[text()='Осталось заполнить поля:']]//span[text()='Телефон']")));
